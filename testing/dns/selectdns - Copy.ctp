                        ...
                        <table id="exampleSingle" class="dataTable cust_tab_pag tablesorterdns" style="width:626px;">
                            <thead> 	
								...
								<tr class="table-top withdatatablecss">
										...
										<th>
											<select id="msds-select" style="width:90px !important;margin-left:5px;float:left;">
											<option></option>
											<?php
										...
										<th><input type="text" id="search_filter_ods" style="width:90px !important;margin-left:5px;float:left;" ></th>
										<th><input type="text" id="search_filter_trunk" style="width:90px !important;margin-left:5px;float:left;" ></th>
                                ...
                                <tr class="table-top withdatatablecss">
								   ...
								   <?php if (isset($scenario_name)) { ?>
									...
									<input type="checkbox"  name="sAll" id="checkAllDn" style="margin-top: 0px !important;border-left: 1px solid #D1D1D1!important;padding-left: 12px !important;margin-left:10px;">
									</th> 
									<?php } else { ?>
									<th class="table-right-ohne withdatatablecss" style="width: 2%!important;padding-left:10px;text-align: left;"><?php //echo __('Select '); ?><input type="checkbox"  name="sAll" id="checkAllDn" style="margin-top: 0px !important;border-left: 1px solid #D1D1D1!important;padding-left: 12px !important;margin-left:10px;"><p style="position: relative;top:<?php echo $top; ?>px;"><?php echo __('tableFilter'); ?></p></th>
									<?php } ?>
                                  ...
                                  <?php   }   ?>
                                     <?php 
										   $odsflag=count($scenarioData);											  
											  if($odsflag!=0){     ?>
                                    <th class="table-column withdatatablecss" style="width:<?php echo $odstablewidth ?>px !important;text-align: left;"><?php echo __("ODS", true); ?></th>
									  <?php   }   ?>
									  <?php if($cst_type!="Phone"){     ?>     
                                    <th class="table-column withdatatablecss" style="width:<?php echo $trunktablewidth ?>px !important;text-align: left;"><?php echo __("trunk", true); ?></th>				                          <?php  }   ?>
...
;
								...
								for (var irow = 0; irow < countlength; irow++)   
								{
									...
									else
									{
										...
										cells[0] = '<input onclick="checkallf()" style="margin-left:19px" type="checkbox" class="selectdnsCheckbox"  id="chk'+getId+'" name="selectdnsCheckbox[]" value="'+getId+'" />';
										...
										for(var i = 0; i < str_array.length; i++) {
										   ...
										   if(str_array[i] == '') continue;
											...
											linkdata += "<li style='list-style:none;'>"+linkName+"</li>";										  
										}									
										cells[3] = linkdata;
