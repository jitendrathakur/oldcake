				  ...
				  <div class="pagerlocationedit form-horizontal" >            
				   ...
				   -->
                        <div id="ajax_load">
							...
							<table id="myTable7" class="dataTable tablesorter phonekey cust_tab_pag" cellpadding="0" cellspacing="0" style="width:98%; border:1px solid #ccc !important; margin-left:5px; border-top-color:#CCC">
								...
								<thead>
                                    <tr class="table-top" style=" border:1px solid #ccc !important; border-bottom:#D1D1D1 1px solid; border-right: 1px solid #D1D1D1;border-top:#D1D1D1 1px solid;">
                                        ...
                                        <th align="left" width="<?php $checkwidth; ?>px !important;border-left: 1px solid #D1D1D1!important;" class="table-column table-left-ohne withdatatablecss" ><input type="checkbox"  name="sAll" id="checkAll" class="showselect" style="margin-top: 5px !important;margin-left:3px !important;"  ></th>
                                        <th align="left" width="<?php echo $dnlocation; ?>px !important" class="table-column dosorting withdatatablecss " style="margin-top: -2px;" ><?php echo __('dnLocation')?> </th>
                                        <th align="left" width="<?php echo $locwidth; ?>px !important" class="table-column filter-select filter-parsed  dosorting withdatatablecss" data-placeholder=""><?php  echo __('Location')?></th>
                                   <?php 
										$checkthirdcol = 0;
							...
							function populate()
							{
								...
								'bDestroy': true,
									...
									"oLanguage": {
										...
										"sLengthMenu": '<div style="float:left"> Total Entries : &nbsp;<div id="counter" style="width:20px;float:right;"></div> </div> <div style="float:right"> Pages - <select style="margin-top:-1px;">' +
									...
									"fnInfoCallback": function( oSettings, iStart, iEnd, iMax, iTotal, sPre ) {
									   ...
									   $('#myTable7_paginate span').html(' Page <input class="GoOnTargetPage" maxlength="maxlength" style="width:25px;text-align:center;float: inherit;" type="text" value="' + currentPage + '" /> of ' + totalPages);
								...
								for (var irow = 0; irow < countlength; irow++)   
								{
									...
									cells[0] = '<input type="checkbox" align="left" id="chk'+getId+'" value="'+getId+'" class="odsentchk">';
									
									
									cells[1] = jArray[irow]['Dns']['id'];
									
									cells[2] = jArray[irow]['Location']['id'];
