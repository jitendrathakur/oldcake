...
<script type="text/javascript">
	...
	function checkallf(checkboxID){
		...
		if ($("#checkAll").is(':checked')) {
					...
					$('.cnt').text("<?php echo __('Update Selected'); ?> : " + selnum);	
					...
					$("#chknumber").val(selnum);	
							...
							//$("#chknumber").val(singlecount);
								$('.cnt').text("<?php echo __('Update Selected'); ?> : " + counter);	
								
								if(counter){
									$('#updateselected a').attr("class", " fancybox fancybox.ajax cntchk_updatemsg2 cnt showhighlight_buttonright");
									$('#updateselected').removeAttr("class");
									$('#updateselected').attr("class", "button-right-hover");	
								}else{
									
									$('#updateselected').attr("class", "button-right-disabled");
									$('#updateselected a').removeAttr("class");
									$('#updateselected a').attr("class", " fancybox fancybox.ajax cntchk_updatemsg2 cnt");
								}
...
<script language="javascript">
    ...
    function toggleTechnical() {
        //$("#advancesearch").show
        if (document.getElementById('showtechnical').style.display == 'none') {
            document.getElementById('showtechnical').style.display = 'block';


        } else {
            document.getElementById('showtechnical').style.display = 'none';
        }
    }
    function toggleLogs() {
        //$("#advancesearch").show
...
.showhighlight_buttonright {
    background: url("../../images/assets/btn-hov-right.gif") no-repeat scroll right center rgba(0, 0, 0, 0) !important;
                    ...
                    var TargetURL = "<?php echo Configure::read('base_url'); ?>locations/filterdnslocation/location_id:<?php echo $location_id; ?>" + "/MinVal:" + MinVal + "/MaxVal:" + MaxVal;
                            ...
                            jQuery('.odsentchk').click(function() {								
								...
								if ($(this).is(':checked')) {
									...
									seldnids = seldnids.replace(checkedval+',', ''); 	
									$("#IDS").val(seldnids);										
								}
							...
							jQuery("select").change(function() {	
									if (jQuery("#checkAll").is(':checked')) {
										jQuery('.odsentchk').prop("checked", "checked");
										
									}
							});
							*/
							jQuery("#myTable7_first, #myTable7_previous, #myTable7_next, #myTable7_last").click(function() {	
									//var noofrecord = 0;
									checkboxall();
							});
							
							jQuery(".paginate_button, .paginate_active").click(function() {	
									//var noofrecord = 0;
									//alert('dd');
									checkboxall();
							});
                            ...
                            jQuery("#checkAll").click(function() {								
                                if (jQuery("#checkAll").is(':checked')) {
									...
									*/
									...
									// jQuery('input', oTable.fnGetFilteredNodes()).attr('checked',this.checked); //note it's calling fnGetFilteredNodes() - this is so it will mark all nodes whether they are filtered or not
									//jQuery('.odsentchk').prop("checked", "checked");
...
$chknumber = $selnumber[0];
 ?>
 <input type="hidden" name="chknumber" id="chknumber" value="<?php echo count($dnsdetail); //$chknumber; ?>"/>
                ...
                <div id="newEdit">
                   <div class="form-body">
                        <div class="form-box">
                           ...
                           <div class="form-right">
                            ...
                            <div style="display:block">					
               				 <h4 style="display:block;float:left;width: 100%;"><?php echo __('technical', true); ?> <a class="maintopRelatedContentButton" id="technicalContentButton" onclick="return toggleTechnical();" href="javascript:void(0)" style="float:right;">
                      		  <div style="width:20px; height:20px;" id="pbtn_schedule">
					...
					<a style="font-weight: normal;font-size: 12px !important;margin-left: 5px;" href="javascript:;" id="edit_stat" onclick="set_visimenu('dispmenu')"  <?php echo $readonly; ?>><?php// __("Options"); ?> </a>
            				...
            				<div id="showtechnical" class="table-content" style="display:none">
                           ...
                           <div class="form-right">
                            ...
                            <div class="form-left">
								...
								$loc_type = __($loctype,true);								
								echo $form->input('Location.loc_source', array('type' => 'text', 'label' => false, 'value' => $location['Location']['loc_type'], 'style' => 'width:140px;', 'readonly' => $readonly ,'class'=>'readtext')); ?>		
					...
					<div  style="display:none">
					 <?php }
                        ...
                        <div id="ajax_load">
							...
							<div class="black_overlay_update12 duplicate1" style="display:block;"></div>
							<table id="myTable7" class="dataTable phonekey" cellpadding="0" cellspacing="0" style="width:98%; border:1px solid #ccc !important; margin-left:5px; border-top-color:#CCC">
								...
								<thead>
									...
									<tr class="tablesorter-filter-row78">
										...
										<td>&nbsp;</td>
										<td><input style="width:93%;" type="text" id="search_filter" ></td>
										
										
										<td>
											<select id="msds-select" style="width:93%; !important;margin-left:5px;float:left;margin-right:4px;">
											<option></option>
											<?php
										...
										<?php
										if($location['Location']['scm_name']=="UNKNOWN"){ ?>
										<td >
											<select id="msds-select-emer"  style="width:90%; !important;margin-left:5px;float:left;margin-right:4px;">
											<option></option>
											<?php
												foreach($emerlist as $list){
												?>
												<option value="<?php echo $list; ?>"><?php echo $list; ?></option>
											<?php	
												}
										...
										if($checkthirdcol){?>
										<td>
											<select id="msds-select-function"  style="width:90%; !important;margin-left:5px;float:left;margin-right:4px;">
											<option></option>
											<?php
                                    ...
                                    <tr class="table-top" style=" border:1px solid #ccc !important; border-bottom:#D1D1D1 1px solid; border-right: 1px solid #D1D1D1;border-top:#D1D1D1 1px solid;">
                                        ...
                                        <th align="left" style=" width: 10px !important;border-right: 1px solid rgb(209, 209, 209) ! important;"  class="table-left-ohne" ><input type="checkbox"  name="sAll" id="checkAll" class="showselect" style="margin-top: 5px !important;margin-left:3px !important;"  ></th>
                                        <th style="width:95px !important;border-right: 1px solid rgb(209, 209, 209) ! important;" align="left"  class="table-column dosorting " style="margin-top: -2px;" ><a href="javascript:void(0);"><?php echo __('dnLocation')?></a> </th>
                                        <th  style="width:120px !important;border-right: 1px solid rgb(209, 209, 209) ! important;" align="left"  class="table-column filter-select filter-parsed  dosorting" data-placeholder=""><a href="javascript:void(0);"><?php  echo __('location')?></a></th>
                                   <?php 
										$checkthirdcol = 0;
										if($location['Location']['scm_name']=="UNKNOWN"){  $checkthirdcol =1; ?>
                                        <th width="40px !important" align="left" class="table-column filter-select filter-exact dosorting" data-placeholder=""><a href="javascript:void(0);"> <?php echo __('emer')?></a></th><?php } ?>
										<?php if($dispfunc=='2') { $checkthirdcol = 1;?>
                                        <th align="left" width="129px !important" class="table-column filter-select filter-exact dosorting" data-placeholder=""><a href="javascript:void(0);"> <?php echo __('Function')?></a></th>
										<?php } ?>
                                    </tr>
									</thead>
...
;
								...
								for (var irow = 0; irow < countlength; irow++)   
								{
									...
									cells[0] = '<input onclick="checkallf('+getId+')" type="checkbox" align="left" id="chk'+getId+'" value="'+getId+'" class="odsentchk">';
									...
									if(checkthirdcol)
									{
										...
										//indext = 3;
										if(scm_name=="UNKNOWN"){
											//alert(jArray[irow]['Dns']['emer']);
											emerval = jArray[irow]['Dns']['emer'];
											//alert(emerval);
											if(emerval == "" || emerval == null || emerval == "undefined"){
												emerval = "<?php echo __('empty',true); ?>";
											}
											
											cells[indext] = emerval;
											indext++;
										}
										...
										if(dispfunc=='2') {
											...
											if(jArray[irow]['Dns']['function']!=''){
												...
												cells[indext] =  functionval;
											}
											else { 
												cells[indext] =  "<?php echo __('free',true); ?>";
											} 
										}
							...
							$(document).ready(function() {
							  ...
							  $('#msds-select').change( function() { 									
							   ...
							   $('#msds-select-emer').change( function() { 									
							    ...
							    $('#msds-select-function').change( function() { 									
									oTable.fnFilter( $(this).val(),indext); 
						...
						<div id="updateselected" class="button-right-disabled" style="margin: 10px 2px 11px !important;float:left !important;">
                            <?php echo $html->link(__("Update Selected", true), array('controller' => 'dns', 'action' => 'openlocationupdateview/customer_id:' . $SELECTED_CUSTOMER_NAME . '/loc_id:' . $location['Location']['id']), array('class' => $selected['DN List'] . " fancybox fancybox.ajax cntchk_updatemsg2 cnt")); ?> 
							</div>
