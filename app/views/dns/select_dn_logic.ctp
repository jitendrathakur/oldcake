										...
										<td>
											...
											<?php
												foreach($locationlist as $list){
													$selected = "";
													if($prelocation == $list) $selected = "selected";
												?>
                        ...
                        <tr class="table-top">
                            ...
                            <?php if (isset($ports) && !empty($ports)) { ?>
                                ...
                                ?> "style="width:102px;text-align: left;">
                                 <div>   <?php echo __("Port Id", true); ?></div></th>
                                ...
                                if (in_array('sort:mediatrix_id', $filter_sort) && in_array('direction:asc', $filter_sort))
                                    ...
                                    echo 'sortlink';
                                ?> "style="width:102px;text-align: left;">
                                   <div> <?php echo __("Mediatrix Id", true); ?></div></th>
                                ...
                                if (in_array('sort:station_id', $filter_sort) && in_array('direction:asc', $filter_sort))
                                    ...
                                    echo 'sortlink';
                                ?> "style="width:102px;text-align: left;">
                                    <div><?php echo __("Station Id", true); ?></div></th>

                                <th class="table-column filter-select filter-exact" style="width:102px;text-align: left;">
                                    <?php echo __("Phone Type", true); ?></th>

                                <th class="table-column filter-select filter-exact" style="width:102px;text-align: left;">
                                   </div> <?php echo __("Port Type", true); ?></div></th>

                            <?php } else { ?>
                                <th class="" style="width:22px !important;"><?php
                                ...
                                ?> "style="width:80px;text-align: left;">
                                    <div><?php echo __("dnId", true); ?></div></th>
                                ...
                                if (in_array('sort:location_id', $filter_sort) && in_array('direction:asc', $filter_sort))
                                    ...
                                    echo 'sortlink';
                                ?> "style="width:102px;text-align: left;" data-value="<?php echo $prelocation;  ?>" ><div><?php echo __("Location", true); ?></div></th>	    	
...
;
								...
								for (var irow = 0; irow < countlength; irow++)   
								{
									...
									if ((functionname != '') && (functionname != 'CFRA') && (functionname != 'UCD') && (functionname != 'INTERNAL'))
									{
										...
										cells[0] = '<input onclick="changebutton()" style="margin-left:13px;margin-bottom: 4px !important;" type="radio" align="left" id="chk'+getId+'" value="'+getId+'" name="selectdnsCheckbox[]" class="selectdnsCheckbox '+getId+'">';
									
										
										
										cells[1] = jArray[irow]['Dns']['id'];
										
										cells[2] = jArray[irow]['Location']['name']+'<input type="hidden" name="locid" id="locid'+dnsid+'" class="locid" value="'+locationid+'">';
								...
								//alert('<?php echo $prelocation; ?>');
								selectedval = $("#msds-select").val();
								if(selectedval != ""){
									t.fnFilter('<?php echo $prelocation; ?>',2); 
								}
