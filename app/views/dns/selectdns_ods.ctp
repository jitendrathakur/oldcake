                   ...
                   // var TargetURL = "<?php echo Configure::read('base_url'); ?>dns/filterdns/scenario_id:<?php echo $scenario_id; ?>" + "/MinVal:" + MinVal + "/MaxVal:" + MaxVal;
					 var TargetURL = "<?php echo Configure::read('base_url'); ?>dns/filterdns/scenario_id:<?php echo $scenario_id; ?>/location_id:<?php echo $location_id; ?>" + "/MinVal:" + MinVal + "/MaxVal:" + MaxVal+"/customer_id:"+customerid;
		        		...
		        		$('#overlay-sucess').removeClass('hide');
                                ...
                                alert("<?php echo __('Please select DN');?>");
                            }
            ...
            if (isset($dns2) && !empty($dns2)) :
                ...
                <div id="loadajax" class="table-content">
                    ...
                    <div class="clear"></div>
                        ...
                        <table id="exampleSingle" class="dataTable cust_tab_pag tablesorterdns" style="width:547px;margin-bottom:15px;">
                            <thead> 	
							
								<tr class="table-top withdatatablecss">
										
										<th style="text-align:center;"><?php //echo __('tableFilter', true);?></th>
										<th><input type="text" id="search_filter_dnId" style="width:90% !important;margin-left:5px;float:left;margin-right:4px;" ></th>
										
										
										<th>
											<select id="msds-select_next" style="width:93% !important;margin-left:5px;float:left;margin-right:4px;">
											<option></option>
											<?php
                                ...
                                <tr class="table-top withdatatablecss">
								   ...
								   <?php if (isset($scenario_name)) { ?>
                                    ...
                                    <th class="table-right-ohne withdatatablecss" style="width: 4%!important;padding-left:2px !important;text-align: left;">
									<input type="checkbox"  name="sAll" id="checkAllDn" style="margin-top: 0px !important;border-left: 1px solid #D1D1D1!important;">
									</th> 
									<?php } else { ?>
									<th class="table-right-ohne withdatatablecss" style="width: 4%!important;padding-left:2px !important;text-align: left;"><?php //echo __('Select '); ?><input type="checkbox"  name="sAll" id="checkAllDn" style="margin-top: 0px !important;border-left: 1px solid #D1D1D1!important;"><p style="position: relative;top:<?php echo $top; ?>px;"><?php //echo __('tableFilter'); ?></p></th>
									<?php } ?>
                                    ...
                                    ?> ">
                                     ...
                                     <?php 
										  //$odsflag=count($scenarioData);											  
											 /// if($odsflag!=0)
											 {     ?>
                                    <th class="table-column withdatatablecss" style="width:129px !important;text-align: left;"> <div  style="margin-left:2px">  <?php echo __("Function", true); ?></div></th>
									  <?php   }   ?>
...
;
								...
								for (var irow = 0; irow < countlength; irow++)   
								{
									...
									cells[0] = '<input onclick="checkallf('+getId+')" style="margin-left:2px" type="checkbox" class="selectdnsCheckbox"  id="chk'+getId+'" name="selectdnsCheckbox[]" value="'+getId+'" />';
