...
<h4 style="text-align: left"><?php  __("Script Details")?>
	<div class='demonstrations'>           
		   <div style="font-size: 18px !important;"> <a href="javascript:;"  style="cursor:pointer;" onMouseOver="Tip('<?php echo __('close_window') ?>', BALLOON, true, ABOVE, false)" onMouseOut="UnTip()" onclick="UnTip(); return fancyboxclose(); ">X</a></div>		  
			...
			<div style="font-size: 18px !important;"><a href="javascript:;"  style="cursor:pointer" onMouseOver="Tip('<b><?php echo __('scriptDetails_helpTitel') ?></b><br/><?php echo __('scriptDetails_helpText') ?>', BALLOON, true, ABOVE, false)" onMouseOut="UnTip()" >?</a></div>				
