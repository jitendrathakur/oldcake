...
if((isset($success)) && $success){?>
	...
	<br>
	    ...
	    echo $form->create('Group',array('action'=>'numbergroups','id'=>'filters','type'=>'GET'));
	    ...
	    <div class="cb">
				    ...
				    <table class="table-content phonekey" width="98%">
						<thead>
								...
								<th  class="table-column"style="width:176px;text-align: left;">&nbsp;<?php __("groupName");?></th>
									<th  class="table-column"style="width:174px;text-align: left;">&nbsp;<?php __("groupType");?></th>
									<th  class="table-column"style="width:116x;text-align: left;">&nbsp;<?php __("groupId");?></th>
			...
			<div class="block" style="margin: 0px;">
				...
				<div class="button-left">
					<?php echo $html->link( __("reset", true),  array('controller'=> 'groups', 'action'=>'numbergroups', 'customer_id:'.$SELECTED_CNN),array('onmouseover'=>'javascript:hoverButtonLeft(this);','onmouseout'=>'javascript:outButtonLeft(this);')); ?>
                </div>
             ...
             <?php } else {
                    ...
                    ?>
                        <div class="form-box">
                            <div class="form-left">
                                <?php
                                echo '<div style="width:auto;margin-right:5px; float: left">' . __('memberLocationFilter', true) . '</div>';
            ...
            <br/> <br/>
                ...
                <a id="button3" href="javascript:void(null);"  onclick="submenuactivity(this,1)"    onmouseover="hoverButtonRight(this)" onmouseout="outButtonRight(this)";><?php __("Add Group");?></a>
						<div class="table-menu">
                    			<div class="table-menu-popup" id="table-popup" style="z-index: 1">
                    				<ul>
                    				<li class="group">										
									<?php echo $html->link( __("Add MADN", true),array('controller'=>'dns', 'action'=>'selectdns/grouptype:madn&type=singleLogic&customer_id='.$SELECTED_CNN.'&page=groupindex'), array('class'=>"fancybox fancybox.ajax")); ?>											
									</li>
									<li class="group">										
									<?php echo $html->link( __("addXLH", true),array('controller'=>'dns', 'action'=>'selectdns/grouptype:mlh&type=singleLogic&customer_id='.$SELECTED_CNN.'&page=groupindex'), array('class'=>"fancybox fancybox.ajax")); ?>											
									</li>
		   ...
		   $url2 = $this->params['url']['url'];		   
			...
			if($url=="" && strlen($url2)>6 ){ 
				#$filter_sort = array('0'=>'groups','1'=>'index','2'=>'Page:1','3'=>'customer_id:'.$SELECTED_CNN,'4'=>'sort:name','5'=>'direction:desc');
				 $urlfilter="groups/numbergroups/page:1/customer_id:$SELECTED_CNN/sort:name/direction:desc";
			?>
			
				<th class="table-column <?php //echo 'sortlink_asc';?>" style="width:152px;text-align: left;">
				<!-- <a id="sortlink" href="<?php echo Configure::read('base_url').$urlfilter; ?>"></a>-->
				 <?php echo __("groupName",true); ?>
				</th>				
			<?php }else{ ?>
          
		  <?php //if(in_array('sort:name',$filter_sort) && in_array('direction:asc',$filter_sort)) echo  'sortlink_asc';elseif((in_array('sort:name',$filter_sort) && in_array('direction:desc',$filter_sort))) echo 'sortlink_desc';else echo 'sortlink';?>
		  
		
			<th class="table-column  "style="width:152px;text-align: left;"><?php //echo $paginator->sort(__("groupName",true), 'name',$filter_options);
			echo __("groupName",true);
			?></th>
			<?php } ?>
			...
			<th class="table-column <?php if(in_array('sort:sub_type',$filter_sort) && in_array('direction:asc',$filter_sort)) echo  'sortlink_asc'; elseif((in_array('sort:sub_type',$filter_sort) && in_array('direction:desc',$filter_sort))) echo 'sortlink_desc';else echo 'sortlink';?> "style="width:152px;text-align: left;"><?php echo $paginator->sort(__("SubType",true),'sub_type',$filter_options);?></th>
	             	...
	             	<!--<td class="table-left">&nbsp;</td>-->
	            		...
	            		<td class="tooltip">
							<div>
								...
								elseif($group['Group']['type'] == 'XLH')
								{
									$ident = $xlh_displaynames[$group['Stationkey']['id']];
									#$ident = $group['Stationkey']['id'];
								}
								else 
								{
